...
<html lang="en">
  <head>
    ...
    <title>Register - Cafe Bongsky</title>
  </head>
  <body>
    <!-- Start Sidebar -->
    <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="">
      <a class="navbar-brand" href="#" style="margin-left: 45%;">
        <img src="assets\img\Bongskiee.png" width="30" height="30" class="d-inline-block align-top" alt="">
    ...
    <!-- End Sidebar -->
    <div class="row">
      <div class="col-sm-9"><img src="assets/img/Pict.png" style="width: 100%;"></div>
        <div class="col-sm-3" style="background-color: #f5f5f5; margin-left: -1%;">
          ...
          <div style="margin-right: 3%; margin-left: 3%;">
              <form action="<?php echo base_url().'Register_controller/register'?>" method="POST">
                  <center>
                      <img src="assets\img\Bongskiee.png" style="width: 75%; height: 225px;">
                  </center>
                  <?php
